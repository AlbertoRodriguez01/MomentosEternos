            ...
            <div className='flex justify-center items-center h-screen'>
                ...
                <div className="login_Form bg-pink-50 px-8 py-6 border border-pink-100 rounded-xl shadow-md">
                    ...
                    <div className="mb-3">
                        <input
                            type="text"
                            placeholder='Imagenes del producto'
                            className='bg-pink-50 text-pink-300 border border-pink-200 px-2 py-2 w-96 rounded-md outline-none placeholder-pink-300'
                        />
                    </div>
                    ...
                    {/* Input Five  */}
                    <div className="mb-3">
                        <textarea name="description" placeholder="Descripcion del producto" rows="5" className=" w-full px-2 py-1 text-pink-300 bg-pink-50 border border-pink-200 rounded-md outline-none placeholder-pink-300 ">
