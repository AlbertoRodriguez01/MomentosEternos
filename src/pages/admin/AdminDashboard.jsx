            ...
            <div className="px-5">
                ...
                <div className="mid mb-5">
                    ...
                    <div className=" bg-pink-50 py-5 rounded-xl border border-pink-100">
                        ...
                        {/* text  */}
                        <div className="">
                            <h1 className=" text-center text-lg text-pink-500"><span className=" font-bold">Nombre: </span>{user?.name}</h1>
                            <h1 className=" text-center text-lg text-pink-500"><span className=" font-bold">Email: </span>{user?.email}</h1>
                            <h1 className=" text-center text-lg text-pink-500"><span className=" font-bold">Rol: </span>{user?.role}</h1>
                        </div>
                    </div>
                </div>
